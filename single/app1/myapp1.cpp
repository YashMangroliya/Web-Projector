...
Student()
{
printf("empty constructor got called\n");
this->rollNumber=0;
this->name[0]='\0';
}
...
{ 
printf("Reached parameterized constructor\n");
...
{ 
printf("Reached copy constructor\n");
this->rollNumber=other.rollNumber;
strcpy(this->name,other.name);
return *this;
}
